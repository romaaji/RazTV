                    ...
                    <div className="container">
                        <div className="article">
                            <div className="row">
                                ...
                                <div className="col-12 col-xl-8">
                                    <iframe src={`https://databasegdriveplayer.co/player.php?imdb=${movieDetails.imdb_id}`} title="Streaming Video" scrolling="no" frameborder="0" height="400px" width="100%" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
                                </div>
                                <div className="col-12 col-xl-8">
